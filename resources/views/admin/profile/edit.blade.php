    ...
    <div class="container">
        <div class="row">
            <div class="col-md-8 mx-auto">
                <h2>プロフィール編集</h2>
                <form_action="{{ action('Admin\ProfileController@update') }}" method="post" enctype="multipart/form-data">
                    @if (count($errors) > 0)
                         <ul>
                    ...
                    <div class="form-group row">
                        <label class="col-md-4" for="name">氏名</label>
                        <div class="col-md-10">
                    ...
                    <div class="form-group-row">
                        <label class="col-md-4" for="hobby">趣味</label>
                        <div class="col-md-10">
